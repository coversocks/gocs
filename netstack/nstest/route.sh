...
ip route del 0.0.0.0/1 via 172.18.0.1
ip route del 128.0.0.0/1 via 172.18.0.1
ip route del 172.18.0.2/32 via 172.18.0.1
ip route del 10.211.55.1/32 via 172.18.0.1